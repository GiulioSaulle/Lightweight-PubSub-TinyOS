...
#line 56
#line 51
typedef struct RadioRouteC$__nesc_unnamed4333 {
  uint16_t nodeID;
  bool isConnected;
  bool isSubscribed[3];
} 
RadioRouteC$ClientInfo;
...
typedef struct RadioRouteC$__nesc_unnamed4334 {
  RadioRouteC$ClientInfo clients[8];
} 
RadioRouteC$PANCoordinator;
...
static inline uint16_t RadioRouteC$generateRandomDelay(uint16_t minDelay, uint16_t maxDelay);
...
static bool RadioRouteC$generateRandomDelay$isSeeded[1000];
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb762d298, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb762d298) {
#line 78
    case 10:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb762d298, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb762d930, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb762d930, msg, payload, len);
#line 78
...
#line 143
{
  ...
  if (err == SUCCESS) {
      sim_log_debug(153U, "radio", "Radio started.\n");
...
#line 149
    {
      ...
      sim_log_debug(154U, "radio", "Radio failed to start. Trying Againg...\n");
...
#line 158
{
  sim_log_debug(155U, "radio", "Radio stopped.\n");
}
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb763c8b0, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb763c8b0, msg, error);
#line 110
}
#line 110
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb74c0ca8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb74c0ca8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb74c0ca8, msg, error);
#line 100
      break;
#line 100
    }
...
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb74bd730, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb74bd730, addr, msg, len);
#line 80
...
#line 123
      ...
      default: 
        sim_log_error(151U, "radio_send", "Trying to send an invalid message type\n");
      return FALSE;
      break;
    }
}
...
#line 270
{
  ...
  if (!RadioRouteC$generateRandomDelay$isSeeded[sim_node()]) {
      srand((uint16_t )TOS_NODE_ID);
      RadioRouteC$generateRandomDelay$isSeeded[sim_node()] = TRUE;
    }
...
#line 86
    {
      ...
      RadioRouteC$Timer0$startOneShot(RadioRouteC$generateRandomDelay(100, 500));
...
#line 162
{
  ...
  sim_log_debug(156U, "timer", "Timer1 fired.\n");
  if (TOS_NODE_ID != 1) {
...
#line 170
      if (payload == (void *)0) {
          ...
          sim_log_error(157U, "radio_pack", "Failed to obtain payload\n");
        }
      else 
#line 173
        {
          ...
          if (!RadioRouteC$generate_send(1, &RadioRouteC$packet[sim_node()], __nesc_ntoh_uint8(payload->messageType.nxdata))) {

              sim_log_error(158U, "radio_send", "Failed to schedule message transmission\n");
            }
          else 
#line 181
            {
              sim_log_debug(159U, "radio_send", "Node %hu Scheduled a CONNECT message to PANC\n", TOS_NODE_ID);
            }
        }
    }
}
...
#line 200
{
  ...
  if (error == SUCCESS) {
      ...
      sim_log_debug(161U, "radio_send", "Packet sent...");
      sim_log_debug_clear(162U, "radio_send", " at time %s \n", sim_time_string());
    }
  else 
    {
      sim_log_error(163U, "radio_send", "Send done error!\n");
    }
}
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  RadioRouteC$generateRandomDelay$isSeeded[__nesc_mote] = FALSE;
